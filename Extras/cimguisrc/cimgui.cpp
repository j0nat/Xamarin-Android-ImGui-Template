...
CIMGUI_API void igSetMousePos(int x, int y)
{
    ImGui::SetMousePos(x, y);
}
CIMGUI_API void igSetMouseDown(int down)
{
    ImGui::SetMouseDown(down);
}


CIMGUI_API void igSetKeyDown(int key, int down)
{
    ImGui::SetKeyDown(key, down);
}
CIMGUI_API int igIsKeyboardWanted()
{
    return ImGui::IsKeyboardWanted();
}
